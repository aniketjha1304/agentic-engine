...
export const WorkflowIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M4 4H20V6H4V4ZM4 10H20V12H4V10ZM4 16H20V18H4V16ZM4 22H20V20H4V22ZM6 8L9 11L15 5"
      fill="currentColor"
    />
  </svg>
);
...
export const CodeIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    ...
    style={{ color: 'currentcolor' }}
  >
    <path d="M5.719 5.094a.5.5 0 0 0-.7.712L7.293 8l-2.272 2.193a.5.5 0 1 0 .7.714L8 8.707l2.574 2.2a.5.5 0 0 0 .7-.714L8.707 8l2.267-2.195a.5.5 0 0 0-.7-.712L8 7.293 5.719 5.094z" fill="currentColor" />
  </svg>
);

export const DiagramIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    width={size}
    viewBox="0 0 16 16"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10.5 1a1.5 1.5 0 0 1 1.415 1H13a1.5 1.5 0 1 1 0 1h-1.085A1.5 1.5 0 0 1 10.5 4h-5A1.5 1.5 0 0 1 4 2.5 1.5 1.5 0 0 1 2.585 1H1a1.5 1.5 0 1 1 0-1h1.585A1.5 1.5 0 0 1 4 .5 1.5 1.5 0 0 1 5.415 1h5zM10.5 2h-5A.5.5 0 0 0 5 2.5H4v1h1a.5.5 0 0 0 .5-.5h5a.5.5 0 0 0 .5.5h1v-1h-1a.5.5 0 0 0-.5-.5zM5.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5V9h.5A.5.5 0 0 1 11 9.5v1a.5.5 0 0 1-.5.5H10v1h-1v-1H7v1H6v-1H5.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 5.5 9H6V8h-.5zM6 9v1h4V9H6z"
      fill="currentColor"
    />
  </svg>
);