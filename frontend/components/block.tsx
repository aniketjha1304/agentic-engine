...
export function Block({
  ...
  const [mode, setMode] = useState<'edit' | 'diff' | 'view'>('view');
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="prose h-full overflow-y-scroll px-4 py-8 md:p-20 items-center">
          <div className="flex flex-row max-w-[600px] mx-auto">
            {isDocumentsFetching && !block.content ? (
              ...
              // New 'view' mode: display the diagram image
              <img
                src={`data:image/png;base64,${block.diagram}`}
